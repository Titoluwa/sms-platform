...
CREATE TABLE "Wallet" (
    ...
    "totalTopups" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
...
CREATE TABLE "Campaign" (
    ...
    "senderName" TEXT NOT NULL DEFAULT 'SMS Campaign',
    "templateId" TEXT,
    "variables" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Recipient" (
    ...
    "failureReason" TEXT,
    "dlr" TEXT,
    "messageCost" DOUBLE PRECISION NOT NULL DEFAULT 0.15,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "ApiKey" (
    ...
    "permissions" TEXT[] DEFAULT ARRAY['sms.send', 'wallet.read']::TEXT[],
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "UserSettings" (
    ...
    "dataRetention" TEXT NOT NULL DEFAULT '30days',
...
-- CreateIndex
CREATE INDEX "Recipient_phoneNumber_idx" ON "Recipient"("phoneNumber");

-- CreateIndex
CREATE UNIQUE INDEX "Message_recipientId_key" ON "Message"("recipientId");
