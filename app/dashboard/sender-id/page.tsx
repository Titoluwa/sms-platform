...
export default function SenderIDPage() {
    ...
    return (
        <div className="p-6 md:p-8 space-y-8">
            <div>
                <h1 className="text-3xl font-bold text-foreground">Sender ID</h1>
                <p className="text-foreground/60 mt-1">Manage your sender IDs, shortcodes, and longcodes</p>
            </div>
                ...
                <div className="col-span-1 md:col-span-2">
                    <Card className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-foreground/60 text-sm font-medium mb-2">Available Sender ID</p>
